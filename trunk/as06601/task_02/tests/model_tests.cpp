...
TEST(NonlinearModelTest, ZeroInputs) {
    double r = nonlinearModel({0.8, 0.15, 0.15, 1.0}, 1.0, 1.0, 1.0);
...
TEST(NonlinearModelTest, NonlinearEffect) {
    NonlinearParams p1{1.0, 1.0, 0.0, 0.0};
NonlinearParams p2{1.0, 2.0, 0.0, 0.0};

double r1 = nonlinearModel(p1, 0.8, 0.15, 1.0);
double r2 = nonlinearModel(p2, 0.8, 0.15, 1.0);
