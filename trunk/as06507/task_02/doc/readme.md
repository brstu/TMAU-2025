...
**Вывод:** В рамках лабораторной работы были успешно реализованы модульные тесты для линейной и нелинейной модели температуры. Основной функциональный модуль model.cpp протестирован полностью, что подтверждается 100% покрытием строк, функций и ветвлений в данном файле. Все разработанные тесты успешно пройдены, что подтверждает корректность работы модели.
