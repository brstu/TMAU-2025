...
```
 ...
 Общий уровень покрытия составляет 26%, однако в этот показатель входят также файлы сторонних библиотек, которые не являются объектом тестирования. function.cpp имеет 100% покрытие.
