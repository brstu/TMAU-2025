...
**Вывод:** В ходе лабораторной работы были разработаны и выполнены модульные тесты для линейной и нелинейной функций с использованием фреймворка Google Test.
