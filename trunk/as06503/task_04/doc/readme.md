...
Для файла ptusa_main устанавливаем минимально необходимые права доступа, например, на чтение, запись и исполнение для владельца и чтение/исполнение для группы (например, 750 или 755), чтобы обеспечить безопасность. Рекомендуется использовать команду:
