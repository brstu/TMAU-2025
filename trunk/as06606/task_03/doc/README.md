...
запросите его в следующем каталоге: багажник\as000xxyy\task_03\doc.
...
Перед подключением к контроллеру необходимо изменить IP-адрес компьютера для Ethernet-порта.
