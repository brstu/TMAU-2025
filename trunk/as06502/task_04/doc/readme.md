...
2025-12-21 03.35.38 INFO   (6) -> Program started (version 2025.12.1.0).

2025-12-21 03.35.38 WARNING(4) -> Bus couplers are enabled.

2025-12-21 03.35.38 NOTICE (5) -> script\_name = "main.plua"

2025-12-21 03.35.38 NOTICE (5) -> current working directory: "/opt/main"

2025-12-21 03.35.38 NOTICE (5) -> path = ".", sys\_path = "./sys", extra\_paths = "./dair

y-sys"

Check shared devices

2025-12-21 03.35.38 DEBUG  (7) -> Total memory used: 492 of 30720 bytes\[ 1.60% ].

2025-12-21 03.35.38 INFO   (6) -> Starting main loop! Sleep time is 2 ms.

2025-12-21 03.35.38 CRITIC (2) -> Network device : s7->"A100":"192.168.1.11" can't conn

ect : timeout (100 ms).

2025-12-21 03.35.40 CRITIC (2) -> Network device : s7->"A100":"192.168.1.11" can't conn

ect : timeout (100 ms).

2025-12-21 03.35.42 CRITIC (2) -> Network device : s7->"A100":"192.168.1.11" can't conn

ect : timeout (100 ms).

2025-12-21 03.35.43 ERROR  (3) -> 1-5-5 : Нет связи с EasyServer.

2025-12-21 03.35.44 ERROR  (3) -> 1-1-2 : Нет связи с узлом I/O 'A100' ('192.168.1.11',
