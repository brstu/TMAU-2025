...
1 Изучить следующий открытый проект - "ptusa-main".
...
## Ошибка в документации ptusa:

В документации присутствует устаревшая схема классов (см. https://github.com/savushkin-r-d/ptusa_main/tree/master/docs/class_scheme).
Создадим обновленную схему.
...
```
Дополнив материалы схем занесем их в репозиторий, создав соответствующий pull request (см. https://github.com/savushkin-r-d/ptusa_main/pull/1162)
